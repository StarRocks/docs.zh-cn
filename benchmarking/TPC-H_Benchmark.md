...
| 表名     | 100G  数据行数 | 100G 数据行数 | 100G StarRocks 导入后磁盘容量 |
| -------- | -------------- | ------------- | ----------------------------- |
| customer | 1500万         | 1500万        | 2.4G                          |
| lineitem | 6亿            | 6亿           | 75G                           |
| nation   | 25             | 25            | 2.2K                          |
| orders   | 1.5亿          | 1.5亿         | 16G                           |
| part     | 2000万         | 2000万        | 2.4G                          |
| partsupp | 8000万         | 8000万        | 11.6G                         |
| region   | 5              | 5             | 389B                          |
| supplier | 100万          | 100万         | 0.14G                         |
...
修改配置文件 conf/starrocks.conf，指定脚本操作的集群地址。
